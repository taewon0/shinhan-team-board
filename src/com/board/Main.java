	...
	public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (menu) {
                ...
                case 4: boardController.contentsBoard(); break;
                case 5: commentController.addComment(); break;
                case 6: commentController.updateComment(); break;
                case 7: commentController.deleteComment(); break;
                case 0:
